...
tomates.addEventListener("click", buscarTomate);
...
pan.addEventListener("click", buscarPan);
...
function noBuscar(){
    ...
    resDiv.innerHTML="No hay resultados";
    
  
}

let lechuga = document.getElementById("lechuga");
lechuga.addEventListener("click", noBuscar);

let harina = document.getElementById("harina");
harina.addEventListener("click", noBuscar);
